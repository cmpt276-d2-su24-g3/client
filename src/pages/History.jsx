                        ...
                        <div className="flex-1 p-4 ml-2 bg-white rounded-lg">
                            <div className='flex justify-between'>
                                <div className='flex flex-col'>
                                    ...
                                    <span className='text-xs text-gray-400'>Select a final destination to view historical latency</span>
                                </div>
                                <Input
                                    className='w-fit'
                                    placeholder='Search data center'
                                    onKeyPress={(e) => e.key == 'Enter' && setSearched(e.target.value)}
                                />
                            </div>
                            <Table>
                                <TableHeader>
                                ...
                                <TableBody className='text-xs'>
                                    {
                                        regions?.map((region, index) => (
                                            ...
                                            <TableRow key={region.code}>
                                                <TableCell><Checkbox/></TableCell> {/* Should this be a button instead? */}
